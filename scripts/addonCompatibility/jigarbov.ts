import { world, ScoreboardObjective, Entity, system } from "@minecraft/server";

//set your stats
export type StatIDs = "lava_sponged" | "fisher_catches" | "slabs_sat_on" | "haxel_block_breaks" | "bulb_color_changes" | "boss_events_triggered" | "blocks_calibrated" | string;

export default class ComputersCompat {
  //set your namespace
  private static addonNameSpace = "poke_pfe";
  //leave the rest!
