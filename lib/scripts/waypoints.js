...
export { PokePFEWaypointComponent };
...
function WaypointUIMainMenu(player, item) {
    ...
    UI.button({ translate: `*%WAYPOINTS [${(_b = waypointConfig.waypoints.length) !== null && _b !== void 0 ? _b : 0}/${WaypointTotal}]` }, `textures/poke/common/waypointRed`);
