    ...
    for (let upgrade of config.upgrades) {
        const upgradeCost = ((upgrade.maxLevel) ?
            ...
            : (upgrade.upgradeAdditive) ?
                Number(upgrade.level) + 1
                : 1);
        UI.button({ translate: `${upgrade.level == upgrade.maxLevel ? "" : "%translation.poke.Upgrade "}${(_a = upgrade.upgradeName) !== null && _a !== void 0 ? _a : upgrade.upgradeItem} [%translation.poke.level: ${upgrade.level == upgrade.maxLevel ? "%poke_pfe.max" : upgrade.level}]\n${upgradeCost == Infinity ? "%poke_pfe.max_level" : `%translation.poke.cost: ${upgradeCost} ${(_b = upgrade.upgradeItemName) !== null && _b !== void 0 ? _b : item.typeId}`}` }, upgrade.level != upgrade.maxLevel && (player.getGameMode() == GameMode.Creative || (upgradeCost && PokeGetItemFromInventory(player, undefined, upgrade.upgradeItem))) ? (_c = upgrade.icon) === null || _c === void 0 ? void 0 : _c.default : (_g = (_e = (_d = upgrade.icon) === null || _d === void 0 ? void 0 : _d.cantUpgrade) !== null && _e !== void 0 ? _e : (_f = upgrade.icon) === null || _f === void 0 ? void 0 : _f.default) !== null && _g !== void 0 ? _g : `textures/poke/common/upgrade`);
    }
    UI.title({ translate: `poke_pfe.upgradeTitle`, with: [(_h = item.nameTag) !== null && _h !== void 0 ? _h : `%poke_pfe.${item.typeId.replace(`poke:`, ``).replace(`poke_pfe:`, ``)}`] });
        ...
        for (let upgrade of config.upgrades) {
            if (response.selection == selection) {
                ...
                if (upgradeCost !== Infinity && HasItem) {
                    ...
                    const compressedUpgradeLevel = (_d = (_c = currentCompressed === null || currentCompressed === void 0 ? void 0 : currentCompressed.upgrades.filter(compressedUpgrade => compressedUpgrade.id == upgrade.id).at(0)) === null || _c === void 0 ? void 0 : _c.level) !== null && _d !== void 0 ? _d : upgrade.level;
