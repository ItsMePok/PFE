...
export { PokeUpgradeUI, PFEPersistenceCoreDefault, PFEFlamingCoreDefault, PFECapacityCoreDefault, PFEUpgradeableComponent, ParsePFEUpgradeComponent };
...
function ParsePFEUpgradeComponent(item, player, component) {
    ...
    if (component.upgrade_ids) {
        for (let upgrade_id of component === null || component === void 0 ? void 0 : component.upgrade_ids) {
            ...
            const compressedUpgrade = compressedUpgrades.upgrades.filter(compressedUpgrade => compressedUpgrade.id == (validUpgrade === null || validUpgrade === void 0 ? void 0 : validUpgrade.id)).at(0);
            if (validUpgrade) {
    ...
    if (upgrades.length < 1) {
        ...
        persistenceUpgrade.level += (_f = (_e = compressedUpgrades.upgrades.filter(compressedUpgrade => (compressedUpgrade === null || compressedUpgrade === void 0 ? void 0 : compressedUpgrade.id) == PFEPersistenceCoreDefault.id).at(0)) === null || _e === void 0 ? void 0 : _e.level) !== null && _f !== void 0 ? _f : 0;
        upgrades.push(persistenceUpgrade);
    }
    let parsedUpgradeInfo = {
        dynamicProperty: (_g = component.dynamic_property) !== null && _g !== void 0 ? _g : "pfe:upgrades",
        id: "poke_pfe:upgradable_component",
        v: 1,
        upgrades: upgrades,
        compressedUpgrades: (_l = JSON.parse((_k = (_j = item.getDynamicProperty((_h = component.dynamic_property) !== null && _h !== void 0 ? _h : "pfe:upgrades")) === null || _j === void 0 ? void 0 : _j.toString()) !== null && _k !== void 0 ? _k : "[]")) !== null && _l !== void 0 ? _l : undefined
    };
        ...
        for (let upgrade of config.upgrades) {
            if (response.selection == selection) {
                ...
                if (HasItem && upgradeCost != Infinity) {
                    ...
                    const thisCompressedUpgrade = currentCompressed ? (_b = PokeGetObjectById(currentCompressed === null || currentCompressed === void 0 ? void 0 : currentCompressed.upgrades, upgrade.id)) === null || _b === void 0 ? void 0 : _b.value : undefined;
                    let compressedNewProperty = {
                        upgrades: currentCompressed ? currentCompressed.upgrades.filter(compressedUpgrade => compressedUpgrade.id != upgrade.id).concat([
                            {
                                id: upgrade.id,
                                level: ((_c = thisCompressedUpgrade === null || thisCompressedUpgrade === void 0 ? void 0 : thisCompressedUpgrade.level) !== null && _c !== void 0 ? _c : upgrade.level) + 1
                            }
                        ]) : []
                    };
                    let newProperty = {
                    ...
                    PokeSaveProperty((_d = component === null || component === void 0 ? void 0 : component.dynamic_property) !== null && _d !== void 0 ? _d : config.dynamicProperty, item, JSON.stringify(compressedSave ? compressedNewProperty : config), player, EquipmentSlot.Mainhand);
                    return;
                }
            }
            else
