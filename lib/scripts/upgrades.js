...
function PokeUpgradeUI(player, item, config, backTo) {
    ...
    for (let upgrade of config.upgrades) {
        ...
        UI.button({ rawtext: [{ translate: `translation.poke.Upgrade` }, (_a = upgrade.upgradeName) !== null && _a !== void 0 ? _a : { text: upgrade.upgradeItem }, { text: `[` }, { translate: `translation.poke.level` }, { text: `:${upgrade.level}]\n` }, { translate: `translation.poke.cost` }, { text: `: ${upgradeCost}` }, { translate: `${(_b = upgrade.upgradeItemName) !== null && _b !== void 0 ? _b : item.typeId}` }] }, (upgradeCost && PokeGetItemFromInventory(player, undefined, upgrade.upgradeItem)) ? (_c = upgrade.icon) === null || _c === void 0 ? void 0 : _c.default : (_g = (_e = (_d = upgrade.icon) === null || _d === void 0 ? void 0 : _d.cantUpgrade) !== null && _e !== void 0 ? _e : (_f = upgrade.icon) === null || _f === void 0 ? void 0 : _f.default) !== null && _g !== void 0 ? _g : `textures/poke/common/upgrade`);
    }
