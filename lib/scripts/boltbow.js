...
import { PFECapacityCoreDefault, PFEFlamingCoreDefault, PFEPersistenceCoreDefault, PokeUpgradeUI } from "./upgrades";
...
function PFEAmmoManagementMainMenuUI(item, player) {
    ...
    UI.button({ translate: `translation.poke:ammoUIQuickReload`, with: { rawtext: [{ text: `${boltBowComponent.projectile.amount}` }, { text: `${((_b = (_a = boltBowComponent.upgrades.filter(upgrade => upgrade.id == PFECapacityCoreDefault.id).at(0)) === null || _a === void 0 ? void 0 : _a.level) !== null && _b !== void 0 ? _b : 1) * 16}` }] } }, `textures/poke/common/ammoQuickReload`);
