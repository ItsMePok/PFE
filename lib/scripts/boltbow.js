...
class PFEBoltBowsComponent {
    onUse(data) {
        ...
        if (ammoComponent.amount >= 1) {
            ...
            if ((((_a = equippableComponent.getEquipmentSlot(EquipmentSlot.Mainhand).getItem()) === null || _a === void 0 ? void 0 : _a.typeId) != ((_b = data.itemStack) === null || _b === void 0 ? void 0 : _b.typeId)) || (equippableComponent.getEquipmentSlot(EquipmentSlot.Mainhand).getDynamicProperty(PFEAmmoProperty) != JSON.stringify([ammoComponent])))
                return;
...
function PFEAmmoUpgrade(player, item) {
    ...
    if (!flamingUpgrade) {
        let newProperty = [{
                ...
                entityId: ammoComponent.entityId,
                id: ammoComponent.id,
                upgrades: ammoComponent.upgrades.concat([(_a = PokeGetObjectById(PFEAmmoStorageDefault.at(0).upgrades, `pfe:flaming`)) === null || _a === void 0 ? void 0 : _a.value])
            }];
