            ...
            if (!providedEvent) {
                ...
                if (replaceEvent) {
                    ...
                    event = {
                        ...
                        name: name,
                        dates: [{
                                days: [Number((_j = (_h = response.formValues) === null || _h === void 0 ? void 0 : _h.at(2)) === null || _j === void 0 ? void 0 : _j.valueOf()) + 1],
                                month: Number((_l = (_k = response.formValues) === null || _k === void 0 ? void 0 : _k.at(3)) === null || _l === void 0 ? void 0 : _l.valueOf())
                            }],
                        gift: undefined,
                        icon: `textures/poke/common/event_default`,
                        repeat: Boolean((_m = response.formValues) === null || _m === void 0 ? void 0 : _m.at(4)),
                        greeting: "generic",
                        fixedTime: false,
                        v: PokeCalendarVersion
                    };
                ...
                let id = (_p = (_o = response.formValues) === null || _o === void 0 ? void 0 : _o.at(0)) === null || _p === void 0 ? void 0 : _p.toString().replace(`custom:`, '').replace(' ', '');
                if (!id) {
                    id = event.id;
                }
                else {
                ...
                let name = { text: (_r = (_q = response.formValues) === null || _q === void 0 ? void 0 : _q.at(1)) === null || _r === void 0 ? void 0 : _r.toString() };
                if ((_t = (_s = response.formValues) === null || _s === void 0 ? void 0 : _s.at(0)) === null || _t === void 0 ? void 0 : _t.toString().startsWith(`%`)) {
                    name = { translate: (_u = response.formValues.at(1)) === null || _u === void 0 ? void 0 : _u.toString().substring(1) };
                }
                let newEvent = {
                    id: id,
                    name: name,
                ...
                let customEvents = (_v = world.getDynamicProperty(PokeCustomEventId)) === null || _v === void 0 ? void 0 : _v.toString().replace(JSON.stringify(event), JSON.stringify(newEvent));
...
function PokeTimeDeleteEvent(player, event) {
    ...
    UI.show(player).then((response => {
        ...
        if (response.canceled) {
            ...
            //@ts-ignore
            let customEvents = JSON.parse(world.getDynamicProperty(PokeCustomEventId));
