...
import { PFECraftQuests, PFEFarmQuests, PFEKillQuests, PFEMineQuests, PFEQuestPropertyID, PFERollQuest } from "./quests";
...
world.beforeEvents.worldInitialize.subscribe(data => {
    ...
    data.itemComponentRegistry.registerCustomComponent("poke_pfe:quest", {
        onUse(data) {
            var _a, _b;
            if (!data.itemStack)
                return;
            if (!data.itemStack.getDynamicProperty(PFEQuestPropertyID)) {
                ...
                let quest = (_a = JSON.parse(data.itemStack.getDynamicProperty(PFEQuestPropertyID).toString())) !== null && _a !== void 0 ? _a : console.warn(`Quest not found or failed to parse || poke_pfe:quest`);
                let validRequiredItems = (_b = PokeGetItemFromInventory(data.source, undefined, quest.requiredItem.item)) !== null && _b !== void 0 ? _b : false;
                let totalItems = 0;
