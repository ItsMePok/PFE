    ...
    switch (data.id) {
        ...
        */
        case PFECustomMineQuestsPropertyID: {
            const currentQuests = (_a = JSON.parse(world.getDynamicProperty(PFECustomMineQuestsPropertyID).toString())) !== null && _a !== void 0 ? _a : [];
            let newQuests = (_b = currentQuests.concat(JSON.parse(data.message).value)) !== null && _b !== void 0 ? _b : currentQuests;
            world.setDynamicProperty(PFECustomMineQuestsPropertyID, JSON.stringify(newQuests));
            break;
        }
        case PFECustomKillQuestsPropertyID: {
            const currentQuests = (_c = JSON.parse(world.getDynamicProperty(PFECustomKillQuestsPropertyID).toString())) !== null && _c !== void 0 ? _c : [];
        ...
        case PFECustomFarmQuestsPropertyID: {
            const currentQuests = (_e = JSON.parse(world.getDynamicProperty(PFECustomFarmQuestsPropertyID).toString())) !== null && _e !== void 0 ? _e : [];
        ...
        case PFECustomCraftQuestsPropertyID: {
            const currentQuests = (_g = JSON.parse(world.getDynamicProperty(PFECustomCraftQuestsPropertyID).toString())) !== null && _g !== void 0 ? _g : [];
