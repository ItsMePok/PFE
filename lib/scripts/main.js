...
import { PFEBossEventConfigName, PFEBossEventTicks, PFEBossEventUIMainMenu, PFEDefaultBossEventSettings, PFEStartBossEvent } from "./bossEvents";
...
import { PFEWaypointDefaultConfig, WaypointDynamicPropertyID, WaypointUIMainMenu } from "./waypoints";
...
system.beforeEvents.startup.subscribe(data => {
    ...
    data.itemComponentRegistry.registerCustomComponent("poke:cc_dodge", {
        onUse(data, componentInfo) {
            ...
            if (amount <= 1) {
                equippableComponent === null || equippableComponent === void 0 ? void 0 : equippableComponent.setEquipment(EquipmentSlot.Mainhand, new ItemStack('minecraft:air', 1));
                return;
            }
    ...
    data.itemComponentRegistry.registerCustomComponent("poke:cc_spawnEgg", {
        onUseOn(data, component) {
            ...
            if (player.getGameMode() == GameMode.Creative)
                return;
            if (amount <= 1) {
                equippableComponent === null || equippableComponent === void 0 ? void 0 : equippableComponent.setEquipment(EquipmentSlot.Mainhand, new ItemStack(MinecraftBlockTypes.Air, 1));
                return;
            }
            equippableComponent === null || equippableComponent === void 0 ? void 0 : equippableComponent.setEquipment(EquipmentSlot.Mainhand, new ItemStack(data.itemStack.typeId, amount - 1));
            return;
    ...
    data.itemComponentRegistry.registerCustomComponent("poke_pfe:waypoint_menu", {
        onUse(data, component) {
            var _a;
