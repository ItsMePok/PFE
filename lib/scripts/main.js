import { system, world, EquipmentSlot, GameMode, EntityComponentTypes, ItemComponentTypes, ItemStack, Direction, BlockVolume, BlockPermutation } from "@minecraft/server";
