...
function* PFEVeinMiner(data) {
    let blocks = [data.block, data.block.above(), data.block.east(), data.block.north(), data.block.south(), data.block.west()];
    let currentBlock = blocks.at(0);
    for (let x = blocks.length; x < 0; blocks = blocks.concat([currentBlock, currentBlock === null || currentBlock === void 0 ? void 0 : currentBlock.above(), currentBlock === null || currentBlock === void 0 ? void 0 : currentBlock.east(), currentBlock === null || currentBlock === void 0 ? void 0 : currentBlock.north(), currentBlock === null || currentBlock === void 0 ? void 0 : currentBlock.south(), currentBlock === null || currentBlock === void 0 ? void 0 : currentBlock.west()])) {
        if (currentBlock === null || currentBlock === void 0 ? void 0 : currentBlock.hasTag(`log`)) { }
    }
}
...
world.beforeEvents.worldInitialize.subscribe(data => {
    ...
    data.itemComponentRegistry.registerCustomComponent("poke:hitEffects", {
        onHitEntity(data) {
            const hit_effects = ["poke:holy_scythe", "poke:hellish_scythe", "poke:godly_scythe", "poke:galactic_scythe", "poke:demonic_slasher", "poke:ember_scythe", "poke:death_scythe", "poke:void_scythe", "poke:radium_scythe", "poke:netherite_scythe", "poke:diamond_scythe", "poke:shade_scythe", "poke:onyx_scythe", "poke:iron_scythe", "poke:gold_scythe", "poke:emerald_scythe", "poke:nebula_scythe", "poke:ban_hammer"];
            if (data.attackingEntity.hasComponent(EntityComponentTypes.Equippable)) {
                //@ts-ignore
                if (data.attackingEntity.getComponent(EntityComponentTypes.Equippable).getEquipment(EquipmentSlot.Mainhand) == undefined)
                    return;
                //@ts-ignore
                if (!hit_effects.includes(data.attackingEntity.getComponent(EntityComponentTypes.Equippable).getEquipment(EquipmentSlot.Mainhand).type.id))
                    return;
                //@ts-ignore
                const itemId = data.attackingEntity.getComponent(EntityComponentTypes.Equippable).getEquipment(EquipmentSlot.Mainhand).typeId;
                switch (itemId) {
    ...
    data.itemComponentRegistry.registerCustomComponent("poke:cc_dodge", new PFEDodge());
    data.itemComponentRegistry.registerCustomComponent("poke:cc_bowAim", new PFEBowAim());
    data.itemComponentRegistry.registerCustomComponent("poke:cc_crossbowAim", new PFECrossbowAim());
    data.itemComponentRegistry.registerCustomComponent("poke:cc_spawnEgg", new PFESpawnEgg());
    data.itemComponentRegistry.registerCustomComponent("poke:cas", new PFECassette());
    data.itemComponentRegistry.registerCustomComponent("poke:cc_on_use", new PFEOnUse());
    data.itemComponentRegistry.registerCustomComponent("poke:cc_zooka", new PFEWindzooka());
    data.itemComponentRegistry.registerCustomComponent("poke:cc_upgrader", new PFEUpgrader());
    //Block Components
    data.blockComponentRegistry.registerCustomComponent("poke:trapdoor_event", new PFETrapdoor());
    data.blockComponentRegistry.registerCustomComponent("poke:fortune", new PFEFortune());
    data.blockComponentRegistry.registerCustomComponent("poke:slabs", new PFESlabs());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_bulbs", new PFEBulbs());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_phantomic_conduit", new PFEPhantomicConduit());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_da_conduit", new PFEDemonicAConduit());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_cobble_gen", new PFECobbleGen());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_cobbler", new PFECobbler());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_block_breaker", new PFEBlockBreaker());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_dirter", new PFEDirter());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_duster", new PFEDuster());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_magnet_block", new PFEMagnetBlock());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_calibrate", new PFECalibrate());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_CaliBlockBreaker", new PFECaliBlockBreaker());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_CaliCobbleGen", new PFECaliCobbleGen());
    data.blockComponentRegistry.registerCustomComponent("poke:crops", new PFECrop());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_barometer", new PFEBarometer());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_lava_sponge", new PFELavaSponge());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_block_seat", new PFEBlockSeat());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_slab_loot", new PFESlabLoot());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_block_interact", new PFEBlockInteract());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_8ball", new PFE8Ball());
    data.blockComponentRegistry.registerCustomComponent("poke:cc_wall", new PFEWall());
    return;
});
export { PFEDamageItemUB };
