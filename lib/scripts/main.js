import { system, world, EquipmentSlot, GameMode, EntityComponentTypes, ItemComponentTypes, ItemStack, Direction, MinecraftDimensionTypes, InputPermissionCategory } from "@minecraft/server";
...
world.beforeEvents.worldInitialize.subscribe(data => {
    ...
    data.itemComponentRegistry.registerCustomComponent(`poke-pfe:identifier`, {
        onUseOn(data) {
            ...
            //@ts-ignore
            let family = data.source.getComponent(EntityComponentTypes.TypeFamily).hasTypeFamily(`namespace:can_drop_seasonal_bag`);
    ...
    data.blockComponentRegistry.registerCustomComponent("poke:cc_calibrate", {
        onPlayerInteract(data) {
            ...
            if (Math.random() > 0.5) {
                if (!data.player)
                    return;
                (_a = data.player) === null || _a === void 0 ? void 0 : _a.sendMessage(`No`);
                data.dimension.spawnEntity(MinecraftEntityTypes.BreezeWindChargeProjectile, data.player.location);
                system.runTimeout(() => { var _a; (_a = data.player) === null || _a === void 0 ? void 0 : _a.kill(); }, 50);
                return;
            }
    ...
    data.blockComponentRegistry.registerCustomComponent("pfe:forgetfullness", {
        onRandomTick(data) {
            var _a, _b, _c, _d, _e, _f;
            let RNG = Math.round(Math.random() * 5);
            switch (RNG) {
                case 0: {
                    if ((_a = data.block.above()) === null || _a === void 0 ? void 0 : _a.isAir) {
                ...
                case 1: {
                    if ((_b = data.block.below()) === null || _b === void 0 ? void 0 : _b.isAir) {
                ...
                case 2: {
                    if ((_c = data.block.north()) === null || _c === void 0 ? void 0 : _c.isAir) {
                ...
                case 3: {
                    if ((_d = data.block.south()) === null || _d === void 0 ? void 0 : _d.isAir) {
                ...
                case 4: {
                    if ((_e = data.block.east()) === null || _e === void 0 ? void 0 : _e.isAir) {
                ...
                case 5: {
                    if ((_f = data.block.west()) === null || _f === void 0 ? void 0 : _f.isAir) {
