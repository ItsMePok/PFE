...
system.beforeEvents.startup.subscribe(data => {
    ...
    data.itemComponentRegistry.registerCustomComponent("poke_pfe:teleport", {
        onUse(data, componentInfo) {
            ...
            if (component.delay) {
                system.runTimeout(() => {
                    data.source.teleport(location !== null && location !== void 0 ? location : data.source.location, { dimension: dimension });
                    if (component.sound) {
                ...
                const cooldownComponent = data.itemStack.getComponent(ItemComponentTypes.Cooldown);
                if (cooldownComponent === null || cooldownComponent === void 0 ? void 0 : cooldownComponent.cooldownCategory) {
                ...
                for (const target of component.targets) {
                    ...
                    if (typeof component.places == "string") {
                        ...
                        for (const parsedBlock of parsedBlocks) {
                            if (block && (parsedBlock.replaces ? parsedBlock.replaces == block.typeId : (component.can_replace ? ((_a = component.can_replace) === null || _a === void 0 ? void 0 : _a.includes(block.typeId)) : block.isAir))) {
