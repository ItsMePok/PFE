...
import { PFETimeConfigUIMainMenu, PFETimeGreeting, PFETimeZoneOffset } from "./time";
...
world.beforeEvents.worldInitialize.subscribe(data => {
    ...
    data.itemComponentRegistry.registerCustomComponent("pfe:timeConfig", {
        onUse(data) {
    ...
    data.itemComponentRegistry.registerCustomComponent("poke:cc_upgrader", {
        onUseOn(data) {
            //@ts-ignore
            const player = data.source;
            //@ts-ignore
