...
function CheckEffects(player, additionalOptions, customParse) {
    ...
    for (let radiusEffect of radius_effects) {
        const effectDuration = Number((_x = world.getDynamicProperty("poke_pfe:setEffectDuration")) !== null && _x !== void 0 ? _x : ArmorEffectDuration);
        ...
        for (let target of targets) {
            target.addEffect(radiusEffect.effect, (_y = radiusEffect === null || radiusEffect === void 0 ? void 0 : radiusEffect.duration) !== null && _y !== void 0 ? _y : effectDuration, { showParticles: false, amplifier: radiusEffect.amp });
        }
    }
}
