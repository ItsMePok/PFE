...
export { PokeDamageItemUB, PokeDamageItem, PokeDecrementStack, PokeErrorScreen, PokeGetItemFromInventory, PokeItemTranslateString, PokeGetObjectById, PokeSaveProperty, PokeGetSegmentOfString, PokeSpawnLootTable, PokeClosestCardinal, getComponentInfoFromDataStorageItems, pokeAddItemsToPlayerOrDrop, pokeAddItemsToContainerOrDrop, pokeSpawnParticle, };
...
function pokeAddItemsToContainerOrDrop(Container, item, dimension, location) {
    if (Container) {
...
function pokeSpawnParticle(particle, dimension, location) {
