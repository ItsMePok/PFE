...
* The  Cobbler is an automation block that is used to generate cobblestone where it is facing when powered with Redstone. Unlike the Cobblestone Generator; this will drop <img src="https://minecraft.wiki/images/Cobblestone_JE5_BE3.png?29624" alt="" data-size="line"> Cobblestone as an item

## <img src="https://minecraft.wiki/images/Name_Tag_JE3_BE2.png?cbdc1&format=original" alt="" data-size="line"> Identifier: <mark style="color:yellow;">**poke\_pfe:cobbler**</mark> <a href="#identifier" id="identifier"></a>
...
* Drops <img src="https://minecraft.wiki/images/Cobblestone_JE5_BE3.png?29624" alt="" data-size="line"> Cobblestone where it is facing unless a container is placed where it would drop its items. In that case it will place the item directly into the container
...
|  ![](https://github.com/ItsMePok/PFE/blob/wikiAssets/blockRenders/CobblestoneGenerator.png?raw=true) | ![Banished Star x4](https://github.com/ItsMePok/PFE/blob/wikiAssets/wikiMain/banished_star_x4.png?raw=true) | ![Diamond Upgrade Core](https://github.com/ItsMePok/PFE/blob/wikiAssets/wikiMain/diamond_upgrade_core.png?raw=true) |
