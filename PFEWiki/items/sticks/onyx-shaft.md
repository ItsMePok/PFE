...
## <img src="https://minecraft.wiki/images/Name_Tag_JE3_BE2.png?cbdc1&format=original" alt="" data-size="line"> Identifier: <mark style="color:yellow;">**poke\_pfe:onyx\_stick**</mark> <a href="#identifier" id="identifier"></a>
...
* 2x <img src="https://github.com/ItsMePok/PFE/blob/wikiAssets/wikiMain/onyx_shaft.png?raw=true" alt="" data-size="line"> Onyx Stick
{% endtab %}
...
| Item                                                                                                                            | Amount | Chance      |
| ------------------------------------------------------------------------------------------------------------------------------- | ------ | ----------- |
| <img src="https://github.com/ItsMePok/PFE/blob/wikiAssets/wikiMain/onyx_shaft.png?raw=true" alt="" data-size="line"> Onyx Stick | 1      | \~30.8%[^1] |
{% endtab %}
{% endtabs %}

[^1]: 8-16 total rolls that could be an Onyx Stick



    \~2.27%(2/88) to select an Onyx Stick
