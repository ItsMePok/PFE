...
<figure><img src="https://github.com/ItsMePok/PFE/blob/wikiAssets/cassette/cassette_mc_disc_wait.png?raw=true" alt=""><figcaption></figcaption></figure>

## <img src="https://minecraft.wiki/images/Book_and_Quill_JE2_BE2.png?2128f" alt="Book and Quill." data-size="line"> Description: <a href="#description" id="description"></a>

* <img src="https://github.com/ItsMePok/PFE/blob/wikiAssets/cassette/cassette_mc_disc_wait.png?raw=true" alt="Cassette: Wait." data-size="line"> Cassette: Wait is an item that lets you listen to music wherever

## <img src="https://minecraft.wiki/images/Name_Tag_JE3_BE2.png?cbdc1&#x26;format=original" alt="" data-size="line"> Identifier: <mark style="color:yellow;">**poke\_pfe:cassette\_mc\_disc\_wait**</mark> <a href="#identifier" id="identifier"></a>
...
### <mark style="color:blue;">**Interacting**</mark>: Fades out any Music currently playing, and starts playing [Wait by C418](https://minecraft.wiki/w/Music_Disc_wait) <a href="#interacting" id="interacting"></a>

### **Crouching +** <mark style="color:blue;">Interacting</mark>: Queues [Wait by C418](https://minecraft.wiki/w/Music_Disc_wait) to play at the end of the current queued music <a href="#crouch-interacting" id="crouch-interacting"></a>
...
|                                                                                                          |                                                                                      |
| :------------------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------: |
| ![Empty Cassette.](https://github.com/ItsMePok/PFE/blob/wikiAssets/cassette/empty_cassette.png?raw=true) | ![Music Disc Wait.](https://minecraft.wiki/images/Music_Disc_wait_JE1_BE1.png?f5bea) |
|                                                                                                          |                                                                                      |
...
* 1x <img src="https://github.com/ItsMePok/PFE/blob/wikiAssets/cassette/cassette_mc_disc_wait.png?raw=true" alt="Cassette: Wait." data-size="line"> Cassette: Wait
{% endtab %}
{% endtabs %}
