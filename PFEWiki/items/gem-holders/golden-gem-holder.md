...
* The Golden Gem Holder is a crafting component used to craft some of the lower tiered [Rings](../../tools/rings/) in PFE

## <img src="https://minecraft.wiki/images/Name_Tag_JE3_BE2.png?cbdc1&format=original" alt="" data-size="line"> Identifier: <mark style="color:yellow;">poke\_pfe:gem\_holder</mark> <a href="#identifier" id="identifier"></a>
...
* 1x <img src="https://github.com/ItsMePok/PFE/blob/wikiAssets/wikiMain/golden_holder.png?raw=true" alt="" data-size="line"> Golden Gem Holder
{% endtab %}
{% endtabs %}
