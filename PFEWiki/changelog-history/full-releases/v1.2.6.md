...
* This Item also can be upgraded to increase things like
  * Ammo capacity (using Capacity Core)
    * +16 per level
* All PFE crossbows (and the vanilla crossbow) have a Boltbow variant

### Added Capacity Core

### Added Identifier

* Interacting on a block will tell you its block identifier

### Arrow Ring will no longer briefly slow the user down when using it

### Improved the Splash Death Potion

* _no I will not be telling you exactly what changed with it :3_

### Adjusted Rarity of some items

* Nebula magnet: common → epic
* Nebula Pickaxe: common → epic
* Nebula Haxel: common → epic
* Nebula Sword: common → epic
* Nebula Logger: common → epic
* Ban Hammer: common → rare
* Ban Hammer Grip: common → uncommon
* Ban Hammer Shaft: common → uncommon
* Ban Hammer Head: common → uncommon
...
### Added items to the Red Present's loot table:
...
### All drops from the Red Present are now equally as likely
