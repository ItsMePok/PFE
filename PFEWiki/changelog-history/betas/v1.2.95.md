...
### When breaking blocks with poke\_pfe:box\_mining without Silk Touch the blocks dropped now [considers the tool used when dropping items](#user-content-fn-5)[^5]
