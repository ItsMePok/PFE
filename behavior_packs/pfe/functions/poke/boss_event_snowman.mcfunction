...
execute as @e[type=poke:snowman,tag=pfe_boss_event,tag=!boss_event_tpfin] at @s run tellraw @a {"rawtext":[{"translate":"translation.poke:boss_event_near_snowman","with":{"rawtext":[{"text":""}]}},{"text":" "},{"selector":"@p"}]}
